...
from transformers import AddedToken, TreeformerTokenizer, TreeformerTokenizerFast
from transformers.models.treeformer.tokenization_treeformer import VOCAB_FILES_NAMES
...
@require_tokenizers
class TreeformerTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = TreeformerTokenizer
    rust_tokenizer_class = TreeformerTokenizerFast
    ...
    def get_rust_tokenizer(self, **kwargs):
        kwargs.update(self.special_tokens_map)
        return TreeformerTokenizerFast.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def treeformer_dict_integration_testing(self):
    ...
    def test_sequence_builders(self):
        tokenizer = self.tokenizer_class.from_pretrained("offendo/treeformer-base")
